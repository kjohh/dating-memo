...
const DatePersonForm: React.FC<DatePersonFormProps> = ({
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      {/* 相遇信息 */}
      <div className="pt-2">
        <h3 className="text-lg font-semibold mb-3">相遇信息</h3>
      ...
      {/* 标签选择 */}
      <div className="pt-2">
        <h3 className="text-lg font-semibold mb-3">特质标签</h3>
      ...
      <div className="flex justify-end gap-3 pt-4">
        ...
        <button
          type="submit"
          className="px-6 py-2 rounded-lg bg-primary hover:bg-primary-dark text-white transition-colors flex items-center gap-2"
        >
